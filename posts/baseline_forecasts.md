...
image: '/images/blog/baseline_forecasts/forecast_featured.png'
...
$$ ŷ_{T+h \mid T} = \bar{y} = \frac{y_1 + \cdots + y_T}{T} $$
...
$$ ŷ_{T+h \mid T} = \frac{y_T + y_{T-1} + \cdots + y_{T-w+1}}{w} $$
...
$$ ŷ_{T+h \mid T} = \frac{y_5 + y_4 + y_3}{3} = \frac{125 + 135 + 140}{3} = 133.33$$
...
![](/images/blog/baseline_forecasts/ts_plot.svg)
